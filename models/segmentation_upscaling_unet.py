...
class PLSegmentationUnetScalingModel(SaveableModel):
    def __init__(self, input_dim: int, hidden_dim: int, kernel_size: int, num_layers: int=1, scaling: int=2, n_start_unet_channels: int=64) -> None:
        super().__init__()
        ...
        self.upscaling_layer = UpScaleDoubleConv(hidden_dim, hidden_dim, bilinear=False)
